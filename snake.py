...
class Snake:
    ...
    def move(self):
        ...
        for i in range(1, len(self.snake_parts)):
            ...
            if self.snake_parts[i].part_type != SNAKE_TAIL:
            ...
            if self.snake_parts[i].part_type != SNAKE_TAIL:
                ...
                turn = (self.snake_parts[i].field_x - self.snake_parts[i-1].field_x,
                        self.snake_parts[i].field_y - self.snake_parts[i-1].field_y)
